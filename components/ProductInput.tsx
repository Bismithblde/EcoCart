...
interface ProductInputProps {
  ...
  onQueryChange?: (productName: string) => void;
  isLoading?: boolean;
}

export default function ProductInput({ onSubmit, onQueryChange, isLoading = false }: ProductInputProps) {
  ...
  return (
    <div className="w-full">
      <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-[1fr_auto]">
        ...
        >
          {isLoading && (
            <svg className="h-4 w-4 motion-safe:animate-spin motion-reduce:animate-none" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
